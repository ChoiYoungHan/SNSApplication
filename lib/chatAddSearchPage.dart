                            ...
                            child: ListView.builder( // 리스트뷰 위젯
                                ...
                                itemBuilder: (context, index){
                                  ...
                                  final List<userProfile> userData = List.generate(Friend_userEmail.length, (index) =>
                                      userProfile(LoginuserEmail[index], LoginuserName[index], LoginuserStateMsg[index], Friend_userUID[index], Friend_userEmail[index], Friend_userName[index], Friend_userImage[index], Friend_userImage[index], Friend_userStateMsg[index], Friend_userNickname[index], Friend_Read_Phone[index]));
