        ...
        child: Container( // 상자 위젯
          ...
          child: Row( // 가로 정렬
            ...
            children: [
              ...
              IconButton(
                onPressed: (){
                  Navigator.pushNamedAndRemoveUntil(context, '/myList', arguments: MyList_UserEmail(userEmail: widget.userEmail, userName: widget.userName, userStateMsg: widget.userStateMsg), (route) => false);
                },
